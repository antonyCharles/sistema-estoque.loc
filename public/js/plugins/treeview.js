...
(function($) {
	...
	function _expand($this) {
		...
		$this.find('>td:first>.treegrid-container>.treegrid-expander')
			.removeClass('treegrid-expander-collapsed fas fa-angle-right')
			.addClass('treegrid-expander-expanded fas fa-angle-down');
		//render items
	...
	function _collapse($this) {
		...
		//expander class
		$this.find('>td:first>.treegrid-container>.treegrid-expander')
			.removeClass('treegrid-expander-expanded fas fa-angle-down')
			.addClass('treegrid-expander-collapsed fas fa-angle-right');
		//hide items
	...
	function _initNode($this, depth, forceExpand) {
		...
		$this.each(function() {
			...
			if ($this.data('count')) {
				if ($this.hasClass('expanded')) $expander.addClass('treegrid-expander-expanded fas fa-angle-down');
				else $expander.addClass('treegrid-expander-collapsed fas fa-angle-right');
			};
			//indent
