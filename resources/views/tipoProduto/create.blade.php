    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">@lang('tipoProduto.subTitleCadastrar')</h4>
                <a href="javascript:history.back()" class="btn btn-outline-light btn-sm"><i class="fas fa-angle-left"></i> @lang('botao.Voltar')</a>
            </div>
            <div class="card-body">
                {!! Form::open(['action' => array('TipoProdutoController@createPost'), 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) !!}
                    <div class="row">
                        <div class="col-12 col-md-12">
                            @include('temps.forms.input',[
                                'input' => 'tpp_descricao', 
                                'label' => trans('label.Descricao'), 
                                'value' => old('tpp_descricao'), 
