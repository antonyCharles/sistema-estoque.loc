...
<div class="main-card mb-3 card">
    ...
    <div class="card-body">
        {!! Form::open(['action' => array('RoleActionController@updatePost',$roleAction->role_action_id), 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) !!}
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    @include('temps.forms.input',[
                        ...
                        'value' => old('name', $roleAction->name ?? null), 
                ...
                <div class="col-12 col-md-6">
                    @include('temps.forms.select',[
                        ...
                        'value' => old('status', $roleAction->status ?? null), 
